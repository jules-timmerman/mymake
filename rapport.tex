...
Dans la fonction \texttt{main}, on vérifie tout d'abord le nombre d'arguments fournis. Si aucun argument n'est fourni (à savoir \texttt{argc} = 1), la cible sera la première règle de la liste.
Sinon, on recherche la règle associée au nom passé en argument et on applique la fonction de construction à cette règle.

On libère ensuite la mémoire utilisée par nos ressources, en l'occurence les règles et la liste de règlee générale.
\end{question}
