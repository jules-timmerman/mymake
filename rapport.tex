...
Nous pouvons alors en déduire le fichier \textbf{Makefile} (figure \ref{code:Makefile}).
...
Nous créons des fichiers \textbf{regles.c} et \textbf{regles.h}, où l'on définit une structure \texttt{regle} par

\begin{figure}[h]
\lstinputlisting[firstline=8,lastline=17, language=c]{regle.h}
\caption{Structure \texttt{regle}}
\end{figure}

Cette structure est munie des fonctions suivantes :

\begin{figure}[h]
\lstinputlisting[firstline=19,lastline=29, language=c]{regle.h}
\caption{Structure \texttt{regle}}
\end{figure}


\begin{figure}[h]
\lstinputlisting[firstline=8,lastline=16, language=c]{regle.c}
\caption{Code source de }
\end{figure}
